...
namespace WebApi.Migrations.ApplicationDb
{
    ...
    [Migration("20230414063144_MigradeApplicationDbHospital")]
    partial class MigradeApplicationDbHospital
    {
            ...
            modelBuilder.Entity("BlogTag", b =>
                {
                    ...
                    b.HasOne("Models.DbEntities.Post.Tag", null)
                        .WithMany()
